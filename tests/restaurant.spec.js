...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(objetoRetornado3.fetchMenu()).toEqual({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} })
    ...
    expect(objetoRetornado5.consumption).toEqual(['coxinha']);
    ...
    objetoRetornado8.order('coxinha');
    expect(objetoRetornado8.pay()).toBe(11.7);
